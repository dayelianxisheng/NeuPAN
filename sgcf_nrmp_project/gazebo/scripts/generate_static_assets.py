...
<link name='base_footprint'/><link name='base_link'><pose relative_to='base_footprint'>0 0 0.1 0 0 0</pose><inertial><mass>20</mass><inertia><ixx>0.5</ixx><iyy>0.8</iyy><izz>1.0</izz></inertia></inertial><collision name='planner_footprint_collision'><geometry><box><size>0.8 0.5 0.2</size></box></geometry></collision><visual name='body'><geometry><box><size>0.8 0.5 0.2</size></box></geometry><material><diffuse>0.15 0.25 0.8 1</diffuse></material></visual></link>
<joint name='base_footprint_to_base_link' type='fixed'><parent>base_footprint</parent><child>base_link</child></joint>
<link name='lidar_link'><pose relative_to='base_link'>0 0 0.1 0 0 0</pose><sensor name='lidar' type='gpu_lidar'><update_rate>10</update_rate><topic>/scan</topic><lidar><scan><horizontal><samples>181</samples><resolution>1</resolution><min_angle>-3.141592653589793</min_angle><max_angle>3.141592653589793</max_angle></horizontal></scan><range><min>0.05</min><max>8.0</max><resolution>0.001</resolution></range><noise><type>gaussian</type><mean>0</mean><stddev>0</stddev></noise></lidar></sensor></link><joint name='lidar_fixed' type='fixed'><parent>base_link</parent><child>lidar_link</child></joint>
<link name='camera_link'><pose relative_to='base_link'>0 0 0.9 0 0 0</pose><sensor name='rgb_camera' type='camera'><update_rate>10</update_rate><topic>/camera/image_raw</topic><camera><horizontal_fov>1.453284681363431</horizontal_fov><image><width>320</width><height>240</height><format>R8G8B8</format></image><clip><near>0.05</near><far>20</far></clip></camera></sensor></link><joint name='camera_fixed' type='fixed'><parent>base_link</parent><child>camera_link</child></joint>
...
def world_files():
 for scene,obstacles in SCENARIOS:
  ...
  xml="<?xml version='1.0'?>\n<sdf version='1.9'><world name='"+scene+"'><gravity>0 0 -9.81</gravity>"+ground+"".join(includes)+"</world></sdf>\n"
